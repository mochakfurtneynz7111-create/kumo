...
def main(args):
    ...
    train_kwargs = dict(data_source=args.data_source)#,use_h5=args.use_h5)
...
#ZYZYZY
parser.add_argument('--model_histo_type', type=str, 
                    help='type of histology model')
parser.add_argument('--model_histo_config', type=str,
                    help='histology model config')
