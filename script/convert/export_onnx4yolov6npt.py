...
parser = argparse.ArgumentParser(description='yolo pt2onnx')
...
#    parser.add_argument('--weights', type=str, default='./yolov6s.pt', help='weights path')
    ...
    # Load PyTorch model
    model = load_checkpoint(args.model_path, map_location=device, inplace=True, fuse=True)  # load FP32 model
    ...
    try:
        ...
        export_file = args.save_path  # filename
        with BytesIO() as f:
